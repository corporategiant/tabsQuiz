...
[Header("Level 2")]
    ...
    {
        //PlayerPrefs.SetString("QRQuizURL", "https://corporategiant.co.uk/tabsQuiz/StreamingAssets/HowiePOKO3311/");
        phpUrl = PlayerPrefs.GetString("QRQuizURL")+"get_data.php";
        //phpUrl = "https://corporategiant.co.uk/tabsQuizData/JustinKOKO3311/get_data.php";
        //phpUrl = "https://corporategiant.co.uk/tabsQuizData/HowiePOKO3311/get_data.php";
    ...
    { 
       //Question1.text = PlayerPrefs.GetString("Level1Question1");
        ...
        PlayerPrefs.SetString("Level1Answer1C", Level1Answer1C);
        PlayerPrefs.SetInt("Level1CorrectAnswer1", Level1CorrectAnswer1);

        PlayerPrefs.SetString("Level1Question2", Level1Question2);
        PlayerPrefs.SetString("Level1Answer2A", Level1Answer2A);
        PlayerPrefs.SetString("Level1Answer2B", Level1Answer2B);
        PlayerPrefs.SetString("Level1Answer2C", Level1Answer2C);
        PlayerPrefs.SetInt("Level1CorrectAnswer2", Level1CorrectAnswer2);

        PlayerPrefs.SetString("Level1Question3", Level1Question3);
        PlayerPrefs.SetString("Level1Answer3A", Level1Answer3A);
        PlayerPrefs.SetString("Level1Answer3B", Level1Answer3B);
        PlayerPrefs.SetString("Level1Answer3C", Level1Answer3C);
        PlayerPrefs.SetInt("Level1CorrectAnswer3", Level1CorrectAnswer3);

        PlayerPrefs.SetString("Level1Question4", Level1Question4);
        PlayerPrefs.SetString("Level1Answer4A", Level1Answer4A);
        PlayerPrefs.SetString("Level1Answer4B", Level1Answer4B);
        PlayerPrefs.SetString("Level1Answer4C", Level1Answer4C);
        PlayerPrefs.SetInt("Level1CorrectAnswer4", Level1CorrectAnswer4);

        PlayerPrefs.SetInt("Level1EnvID", Level1EnvID);

        PlayerPrefs.SetString("Level2Question1", Level2Question1);
        PlayerPrefs.SetString("Level2Answer1A", Level2Answer1A);
        PlayerPrefs.SetString("Level2Answer1B", Level2Answer1B);
        PlayerPrefs.SetString("Level2Answer1C", Level2Answer1C);
        PlayerPrefs.SetInt("Level2CorrectAnswer1", Level2CorrectAnswer1);

        PlayerPrefs.SetString("Level2Question2", Level2Question2);
        PlayerPrefs.SetString("Level2Answer2A", Level2Answer2A);
        PlayerPrefs.SetString("Level2Answer2B", Level2Answer2B);
        PlayerPrefs.SetString("Level2Answer2C", Level2Answer2C);
        PlayerPrefs.SetInt("Level2CorrectAnswer2", Level2CorrectAnswer2);

        PlayerPrefs.SetString("Level2Question3", Level2Question3);
        PlayerPrefs.SetString("Level2Answer3A", Level2Answer3A);
        PlayerPrefs.SetString("Level2Answer3B", Level2Answer3B);
        PlayerPrefs.SetString("Level2Answer3C", Level2Answer3C);
        PlayerPrefs.SetInt("Level2CorrectAnswer3", Level2CorrectAnswer3);

        PlayerPrefs.SetString("Level2Question4", Level2Question4);
        PlayerPrefs.SetString("Level2Answer4A", Level2Answer4A);
        PlayerPrefs.SetString("Level2Answer4B", Level2Answer4B);
        PlayerPrefs.SetString("Level2Answer4C", Level2Answer4C);
        PlayerPrefs.SetInt("Level2CorrectAnswer4", Level2CorrectAnswer4);

        PlayerPrefs.SetInt("Level2EnvID", Level2EnvID);

        PlayerPrefs.SetString("Level3Question1", Level3Question1);
        PlayerPrefs.SetString("Level3Answer1A", Level3Answer1A);
        PlayerPrefs.SetString("Level3Answer1B", Level3Answer1B);
        PlayerPrefs.SetString("Level3Answer1C", Level3Answer1C);
        PlayerPrefs.SetInt("Level3CorrectAnswer1", Level3CorrectAnswer1);

        PlayerPrefs.SetString("Level3Question2", Level3Question2);
        PlayerPrefs.SetString("Level3Answer2A", Level3Answer2A);
        PlayerPrefs.SetString("Level3Answer2B", Level3Answer2B);
        PlayerPrefs.SetString("Level3Answer2C", Level3Answer2C);
        PlayerPrefs.SetInt("Level3CorrectAnswer2", Level3CorrectAnswer2);

        PlayerPrefs.SetString("Level3Question3", Level3Question3);
        PlayerPrefs.SetString("Level3Answer3A", Level3Answer3A);
        PlayerPrefs.SetString("Level3Answer3B", Level3Answer3B);
        PlayerPrefs.SetString("Level3Answer3C", Level3Answer3C);
        PlayerPrefs.SetInt("Level3CorrectAnswer3", Level3CorrectAnswer3);

        PlayerPrefs.SetString("Level3Question4", Level3Question4);
        PlayerPrefs.SetString("Level3Answer4A", Level3Answer4A);
        PlayerPrefs.SetString("Level3Answer4B", Level3Answer4B);
        PlayerPrefs.SetString("Level3Answer4C", Level3Answer4C);
        PlayerPrefs.SetInt("Level3CorrectAnswer4", Level3CorrectAnswer4);

        PlayerPrefs.SetInt("Level3EnvID", Level3EnvID);
                
        PlayerPrefs.SetString("Level4Question1", Level4Question1);
        PlayerPrefs.SetString("Level4Answer1A", Level4Answer1A);
        PlayerPrefs.SetString("Level4Answer1B", Level4Answer1B);
        PlayerPrefs.SetString("Level4Answer1C", Level4Answer1C);
        PlayerPrefs.SetInt("Level4CorrectAnswer1", Level4CorrectAnswer1);

        PlayerPrefs.SetString("Level4Question2", Level4Question2);
        PlayerPrefs.SetString("Level4Answer2A", Level4Answer2A);
        PlayerPrefs.SetString("Level4Answer2B", Level4Answer2B);
        PlayerPrefs.SetString("Level4Answer2C", Level4Answer2C);
        PlayerPrefs.SetInt("Level4CorrectAnswer2", Level4CorrectAnswer2);

        PlayerPrefs.SetString("Level4Question3", Level4Question3);
        PlayerPrefs.SetString("Level4Answer3A", Level4Answer3A);
        PlayerPrefs.SetString("Level4Answer3B", Level4Answer3B);
        PlayerPrefs.SetString("Level4Answer3C", Level4Answer3C);
        PlayerPrefs.SetInt("Level4CorrectAnswer3", Level4CorrectAnswer3);

        PlayerPrefs.SetString("Level4Question4", Level4Question4);
        PlayerPrefs.SetString("Level4Answer4A", Level4Answer4A);
        PlayerPrefs.SetString("Level4Answer4B", Level4Answer4B);
        PlayerPrefs.SetString("Level4Answer4C", Level4Answer4C);
        PlayerPrefs.SetInt("Level4CorrectAnswer4", Level4CorrectAnswer4);

        PlayerPrefs.SetInt("Level4EnvID", Level4EnvID);
