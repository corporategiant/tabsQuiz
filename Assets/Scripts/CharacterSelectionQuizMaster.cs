...
public class CharacterSelectionQuizMaster : MonoBehaviour
{
    ...
    void Awake()
    {
        username = PlayerPrefs.GetString("QuizMasterusername");
        StudentID = PlayerPrefs.GetString("QuizMasterStudentID");
